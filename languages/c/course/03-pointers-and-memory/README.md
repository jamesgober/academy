...
| # | Lesson |
|---|--------|
| 01 | [Memory Addresses in Plain Language](./01-memory-addresses-in-plain-language.md) |
| 02 | [What a Pointer Really Stores](./02-what-a-pointer-really-stores.md) |
| 03 | [Dereferencing Without Hand-Waving](./03-dereferencing-without-hand-waving.md) |
| 04 | [Function Arguments and Pointers](./04-function-arguments-and-pointers.md) |
| 05 | [Common Pointer Mistakes](./05-common-pointer-mistakes.md) |
| 06 | [Dynamic Memory: `malloc`, `calloc`, `free`](./06-dynamic-memory-malloc-calloc-free.md) |
